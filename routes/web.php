...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/add-stock-product', [ProductController::class, 'addStockProduct'])->name('add-stock-product');
    ...
    Route::post('/to-shimkent', [ProductController::class, 'toShimkent'])->name('to-shimkent');
